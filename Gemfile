...
gem 'config' #, '~> 0.4.2' # TODO: consider removing after importer settings refactored
...
group :development, :test do
  ...
  gem 'factory_bot_rails' #, '~> 4.5.0' # use factories to produce objects
  ...
  gem 'web-console' #, '~> 3.3.0' # debugging tools for Rails
end
