...
def an_unordered_list_of_orphans_exists
  FactoryBot.create(:orphan, name: "Carl", date_of_birth: "14 April 2015")
  FactoryBot.create(:orphan, name: "Aaron", date_of_birth: "15 April 2015")
  FactoryBot.create(:orphan, name: "Tom", date_of_birth: "12 April 2015")
  FactoryBot.create(:orphan, name: "John", date_of_birth: "11 April 2015")
  FactoryBot.create(:orphan, name: "Bob", date_of_birth: "13 April 2015")
end
